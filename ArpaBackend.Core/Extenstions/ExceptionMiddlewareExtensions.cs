...
namespace ArpaBackend.Core.Extenstions
{
                ...
                app.UseExceptionHandler(appError =>
                {
                    appError.Run(async context =>
                    {
                        ...
                        if (contextFeature != null)
                        {
                            ...
                            context.Response.ContentType = "application/problem+json";
                            await context.Response.WriteAsync(new BaseDTO((int)HttpStatusCode.InternalServerError, "خطای ناشناخته رخ داده است", contextFeature.Error).ToSerilizedString());
                        }
                    });
                });
